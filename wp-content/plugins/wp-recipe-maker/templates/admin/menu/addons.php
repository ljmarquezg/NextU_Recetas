...
<div class="wrap wprm-addons">
	...
	<div class="wprm-addons-bundle-container">
		...
		<div class="wprm-addons-button-container">
			<a class="button button-primary" href="https://bootstrapped.ventures/downloads/wp-recipe-maker-premium/" target="_blank">Learn More</a>
		</div>
	...
	<div class="wprm-addons-bundle-container">
		...
		<div class="wprm-addons-button-container">
			<a class="button button-primary" href="https://bootstrapped.ventures/wp-recipe-maker/nutrition-api/" target="_blank">Learn More</a>
		</div>
		...
		<div class="wprm-addons-button-container">
			<a class="button button-primary" href="https://bootstrapped.ventures/wp-recipe-maker/unit-conversion/" target="_blank">Learn More</a>
		</div>
	...
	<div class="wprm-addons-bundle-container">
		...
		<div class="wprm-addons-button-container">
			<a class="button button-primary" href="https://bootstrapped.ventures/wp-recipe-maker/recipe-submission/" target="_blank">Learn More</a>
		</div>
