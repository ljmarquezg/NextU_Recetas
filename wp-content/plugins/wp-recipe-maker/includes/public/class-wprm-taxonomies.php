...
class WPRM_Taxonomies {
	...
	public static function insert_default_taxonomy_terms() {
		...
		if ( taxonomy_exists( 'wprm_ocations' ) ) {
			wp_insert_term( __( 'Formal',           'wp-recipe-maker' ), 'wprm_ocacion' );
			wp_insert_term( __( 'Informal',         'wp-recipe-maker' ), 'wprm_ocacion' );
			wp_insert_term( __( 'Toda Ocación',    'wp-recipe-maker' ), 'wprm_ocacion' );
		}
