...
class WPRM_Tools_Manager {
	...
	public static function add_submenu_page() {
		...
		add_submenu_page( null, __( 'Finding Ratings', 'wp-recipe-maker' ), __( 'Finding Ratings', 'wp-recipe-maker' ), 'manage_options', 'wprm_finding_ratings', array( __CLASS__, 'finding_ratings' ) );
	}
