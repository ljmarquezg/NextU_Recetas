...
class WPRM_Shortcode {
	...
	public static function jump_to_recipe_shortcode( $atts ) {
		...
		if ( $recipe_id ) {
			return '<a href="#wprm-recipe-container-' . esc_attr( $recipe_id ) . '" class="wprm-jump-to-recipe-shortcode">' . $text . '</a>';
		} else {
			return '';
		}
	}
	...
	public static function print_recipe_shortcode( $atts ) {
		...
		if ( $recipe_id ) {
			...
			return '<a href="' . $url . '" class="wprm-print-recipe-shortcode" data-recipe-id="' . esc_attr( $recipe_id ) . '" rel="nofollow">' . $text . '</a>';
		} else {
			return '';
		}
	}
