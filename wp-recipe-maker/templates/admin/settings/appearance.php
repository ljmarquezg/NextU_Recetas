...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope="row">
					<label for="recipe_snippets_alignment"><?php esc_html_e( 'Snippet Alignment', 'wp-recipe-maker' ); ?></label>
				</th>
				<td>
					<select id="recipe_snippets_alignment" name="recipe_snippets_alignment">
						<?php
						$options = array(
						...
						$setting = WPRM_Settings::get( 'recipe_snippets_alignment' );
...
<?php endif; ?>
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				<th scope="row">
					<label for="recipe_author_custom_default"><?php esc_html_e( 'Default custom author name', 'wp-recipe-maker' ); ?></label>
				</th>
				<td>
					<input name="recipe_author_custom_default" type="text" id="recipe_author_custom_default" value="<?php echo esc_attr( WPRM_Settings::get( 'recipe_author_custom_default' ) ); ?>" class="regular-text">
				</td>
			</tr>
			<tr>
				<th scope="row">
			...
			<tr>
				<th scope="row">
					<?php esc_html_e( 'Show nutrition values when 0', 'wp-recipe-maker' ); ?>
				</th>
				<td>
					<label for="nutrition_label_zero_values">
						<?php $checked = WPRM_Settings::get( 'nutrition_label_zero_values' ) ? ' checked="checked"' : ''; ?>
						<input name="nutrition_label_zero_values" type="checkbox" id="nutrition_label_zero_values"<?php echo esc_html( $checked ); ?> />
						<?php esc_html_e( 'Show nutrient in the nutrition label when it has a value of 0', 'wp-recipe-maker' ); ?>
					</label>
				</td>
			</tr>
		</tbody>
	...
	<table class="form-table">
		...
		<?php if ( WPRM_Settings::get( 'features_custom_style' ) ) : ?>
			<tr>
				<th scope="row">
					<label for="template_instruction_image_alignment"><?php esc_html_e( 'Instruction Image Alignment', 'wp-recipe-maker' ); ?></label>
				</th>
				<td>
					<select id="template_instruction_image_alignment" name="template_instruction_image_alignment">
						<?php
						$options = array(
							'left' => __( 'Left', 'wp-recipe-maker' ),
							'center' => __( 'Center', 'wp-recipe-maker' ),
						...
						$setting = WPRM_Settings::get( 'template_instruction_image_alignment' );
						foreach ( $options as $option => $label ) {
							$selected = $setting === $option ? ' selected="selected"' : '';
							echo '<option value="' . esc_attr( $option ) . '"' . esc_attr( $selected ) . '>' . esc_html( $label ) . '</option>';
						}
